...
<template>
  <div class="flex mb-3" :class="{
    ...
    <!-- 头像（仅对方显示） -->
    <img v-if="msg.sender !== 'me' && avatar" :src="avatar" alt="avatar" class="w-8 h-8 rounded-full mr-2 self-end" />

    <!-- 消息内容 -->
    <div class="max-w-[70%] px-3 py-2 rounded-lg" :class="{
    ...
    <!-- 头像（仅自己显示） -->
    <img v-if="msg.sender === 'me' && myAvatar" :src="myAvatar" alt="my avatar"
